...
//    }
    ...
    public void onBindViewHolder(@NonNull BaseViewHolder holder, int positions) {
        ...
        bindViewClickListener(holder,positions);
    }

    private void bindViewClickListener(final BaseViewHolder baseViewHolder, int position) {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (getOnItemClickListener() != null && baseViewHolder != null) {
                    ...
                    getOnItemClickListener().onItemClick(VBaseAdapter.this, v, position );
                }
        ...
        view.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                if (getOnItemLongClickListener() != null && baseViewHolder != null) {
                    return getOnItemLongClickListener().onItemLongClick(VBaseAdapter.this, v, position );
                }
                return false;
